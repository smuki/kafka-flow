namespace KafkaFlow.Microsoft.DependencyInjection
{
    ...
    public class MicrosoftDependencyConfigurator : IDependencyConfigurator
    {
        ...
        {
            this.services.Add(ServiceDescriptor.Describe(typeof(TService), typeof(TImplementation), ParseLifetime(lifetime)));
            return this;
        }
        ...
        public IDependencyConfigurator Add<TService>(InstanceLifetime lifetime)
            where TService : class
        {
            this.services.Add(ServiceDescriptor.Describe(typeof(TService), typeof(TService), ParseLifetime(lifetime)));
            return this;
        }
